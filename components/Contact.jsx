  ...
  return (
    ...
    >
      ...
      <form className="max-w-2xl mx-auto">
        ...
        <textarea rows="6" placeholder="Enter your message" required className="w-full p-4 outline-none border-[0.5px] border-gray-400 rounded-md bg-white mb-6 resize-none"></textarea>
