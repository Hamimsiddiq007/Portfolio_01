...
const Header = () => {
  return (
    <div className='w-11/12 max-w-3xl mt-24 lg:mt-6 text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
      <div className="">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
        ...
        <a href="/sample-resume.pdf" download className='px-10 py-3 border border-gray-500 rounded-full flex items-center gap-2 bg-white dark:text-black'>My resume <Image src={assets.download_icon} alt='' className='w-4'/></a>
      </div>
    </div>
  )
}
